...
export default {
	...
	methods: {
		...
		async loadDirectory(directory = Path.macros + (this.isLocal ? "/_Machine": "")) {
			...
			console.log(len == 1, this.filelist[0].isDirectory, this.filelist[0].name.startsWith(this.getTool.substring(0,5)), !this.filelist[0].directory.includes(this.getTool.substring(0,5)))
