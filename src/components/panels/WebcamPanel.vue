...
@keyframes spin-lynx {
	0% { transform: rotate(0deg);
		...
		border-left-color: #2d4ea2;
		border-right-color: #2d4ea2;
	}
	50% { transform: rotate(90deg);
		border-top-color: #2d4ea2;
		border-bottom-color: #2d4ea2;
...
<template>
	<v-card>
		...
		<v-card-text class="pt-0 img-container">
			...
			<div v-else style="min-height: 480px">
				...
				<img v-else :alt="$t('panel.webcam.alt')" :src="url" :class="imgClasses" id="webcam" style="position: relative; min-width: 480px; background-image: url('/img/ressources/noSignal.gif'); display: inline-block; min-height: 360px; background-position: center; margin: 0 auto">
			</div>
		</v-card-text>
	</v-card>
</template>
