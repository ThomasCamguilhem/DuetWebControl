...
export default {
    ...
    methods: {
                            ...
                            if (this.gcodeLayers[this.curLay - 1] || this.gcodeLayers[this.curLay] || ((this.slicer == undefined || this.slicer == this.Slicer.SLIC) && this.nbLayers > 0) || this.gcodeLayers.length > 1) {
                              ...
                              if ((this.boundingBox.max.x > this.boundingBox.min.x) || (this.boundingBox.max.y > this.boundingBox.min.y) || (this.boundingBox.max.z > this.boundingBox.min.y)) {
                                if (!this.scene.preview.previewScene.getObjectByName("bbox")) {
                                    ...
                                    this.scene.preview.previewControls.object.position.set( this.centerY, 0, -this.centerX);
                                    if (this.nbLayers && this.layHeight && (this.boundingBox.max.z < this.lastPos.z)) {
                                ...
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.min.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.min.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.min.z, this.boundingBox.min.x));

                                // sides bbox
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.min.z, this.boundingBox.min.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.max.z, this.boundingBox.min.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.min.y, this.boundingBox.max.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.max.z, this.boundingBox.max.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.min.z, this.boundingBox.min.x));
                                geo.vertices.push(new THREE.Vector3(this.boundingBox.max.y, this.boundingBox.max.z, this.boundingBox.min.x));
        ...
        setPoly: function(start, end) {
            ...
            //console.log("line 1 from ("+start_x+", " + start_y + ") to (" + end_x +", "+end_y+")");
            ...
            //console.log("line 2 from ("+start_x+", " + start_y + ") to (" + end_x +", "+end_y+")");
